...
from ..handlers import BancoINVICOSdoFinal, login
...
class BancoINVICOSdoFinalService:
    ...
    banco_invico: BancoINVICOSdoFinal = field(init=False)  # No se pasa como argumento

    # -------------------------------------------------
    def __post_init__(self):
        self.banco_invico = BancoINVICOSdoFinal()
    ...
    async def sync_banco_invico_from_sscc(
        ...
        username: str,
        password: str,
        params: BancoINVICOSdoFinalParams = None,
        ...
        try:
            ...
            for ejercicio in ejercicios:
                try:
                    ...
                    filename = (
                        f"{ejercicio} - Bancos - Consulta General de Movimientos.csv"
                    )
