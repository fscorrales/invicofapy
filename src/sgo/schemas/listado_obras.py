...
# --------------------------------------------------
class ListadoObrasParams(BaseModel):
    ...
    def check_range(self) -> "ListadoObrasParams":
...
# -------------------------------------------------
class ListadoObrasReport(BaseModel):
    ejercicio: int
    cod_barrio: str
    barrio: str
    saldo_inicial: float
...
# -------------------------------------------------
class ListadoObrasDocument(ListadoObrasReport):
    id: PydanticObjectId = Field(alias="_id")


# -------------------------------------------------
class ListadoObrasFilter(BaseFilterParams):
