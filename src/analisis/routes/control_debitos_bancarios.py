...
from ..services import ControlDebitosBancariosServiceDependency

control_debitos_bancarios_router = APIRouter(prefix="/debitos_bancarios")


# -------------------------------------------------
@control_debitos_bancarios_router.post(
...
async def sync_control_debitos_bancarios_from_source(
    ...
    params: Annotated[ControlDebitosBancariosSyncParams, Depends()],
):
    if auth.is_admin:
    ...
    return await service.sync_control_debitos_bancarios_from_source(params=params)
...
# -------------------------------------------------
@control_debitos_bancarios_router.get(
    "/export",
