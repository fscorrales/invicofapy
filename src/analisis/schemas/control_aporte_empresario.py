...
# --------------------------------------------------
class ControlAporteEmpresarioParams(CamelModel):
    ...
    def check_range(self) -> "ControlAporteEmpresarioParams":
...
# --------------------------------------------------
class ControlAporteEmpresarioSyncParams(ControlAporteEmpresarioParams):
