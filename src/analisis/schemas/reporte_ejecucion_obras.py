...
# --------------------------------------------------
class ReporteEjecucionObrasParams(CamelModel):
    ...
    def check_range(self) -> "ReporteEjecucionObrasParams":
...
# --------------------------------------------------
class ReporteEjecucionObrasSyncParams(ReporteEjecucionObrasParams):
